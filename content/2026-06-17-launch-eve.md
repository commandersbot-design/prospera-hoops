# Prospera Hoops — Content for Tue 6/17 (Launch Eve)

**Launch is TOMORROW (6/18).** Today is the final hype day. 4 posts, staggered.
...
>
> 📲 Every player's growth arc on Prospera Hoops — live tomorrow.
> Box scores: Capitol Hoops Summer League.

`#ProsperaHoops #TheLeap #DMVHoops #DeMatha #PlayerDevelopment`

### ③ DMV Summer Scoring Leaders 🏀
> 🏀 DMV SUMMER SCORING LEADERS — Drew Hill 28.8 (St. John's) · Will Braun-Duin 28.6 (John Handley) · Jeremiah Williams 28.3 (Walter Johnson) · Gabe Colston 28.0 (JFK) · Jordan Fox 27.9 (DOZA).
>
> Real box scores. No fake rankings. No hype. Full board — live tomorrow.
> Box scores: Capitol Hoops Summer League.

`#ProsperaHoops #DMVHoops #CapitolHoops #SummerLeague`
*(Min. 5 GP — keeps the board credible.)*

### ④ Launch Countdown ⏳
> ⏳ TOMORROW. Every DMV hooper. Every team. Real stats, tracked over time. On the board. You're already on it — claim your profile free at launch.
>
> prosperahoops.com · 6.18

`#ProsperaHoops #DMVHoops #DMVBasketball`

---

## Hashtag bank
`#ProsperaHoops #DMVHoops #DMVBasketball #CapitolHoops #SummerLeague #TheLeap`
`#PlayerDevelopment #DMVScouting #MarylandBasketball #VirginiaBasketball`
